...
import 'package:tunani_fly/barriers.dart';
import 'package:tunani_fly/bird.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> showLoseDialog() async {
    await CoolAlert.show(
      ...
      title: 'Game Over',
      text: score <= 0 ? 'Pas de chance 😂' : 'Super! Vous avez $score points! 🤩',
      confirmBtnText: 'Ressayer',
      cancelBtnText: 'Sortir',
